...
class ContactForm extends Component {
    ...
    render() {
        return (
            <Form id="contact-form" className="m-2 p-3" onSubmit={this.handleSubmit} noValidate validated={this.state.validated}>
                ...
                <Form.Row className="justify-content-center">
                    <Button type="submit" variant="primary" className="text-light">Enviar</Button>
                </Form.Row>
            </Form>
